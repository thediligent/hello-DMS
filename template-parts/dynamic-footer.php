...
?>
<footer id="site-footer" class="site-footer py-5 dynamic-footer <?php echo esc_attr( $footer_class ); ?>">
	<div class="footer-inner py-3">
		<div class="site-branding show-<?php echo esc_attr( hello_elementor_get_setting( 'hello_footer_logo_type' ) ); ?>">
			...
			if ( $site_name && ( 'logo' !== hello_elementor_get_setting( 'hello_footer_logo_type' ) ) || $is_editor ) : ?>
				<div class="site-title d-none <?php echo esc_attr( hello_show_or_hide( 'hello_footer_logo_display' ) ); ?>">
