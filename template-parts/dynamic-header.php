...
<header id="site-header" class="site-header dynamic-header <?php echo esc_attr($header_class); ?>">
	<div class="header-inner align-items-center justify-content-end">
		...
		<?php if ($header_nav_menu): ?>
			<nav class="ms-auto site-navigation <?php echo esc_attr(hello_show_or_hide('hello_header_menu_display')); ?>"
		...
		<div class="form-check form-switch">
			...
			<label class="form-check-label" for="toggleTheme">Toggle Dark</label>
		</div>
	</div>
</header>